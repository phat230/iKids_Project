...
def load_css(file_name):
    ...
    file_name: tên file kèm thư mục con, ví dụ 'admin/manage_users.css'
    """
    # Lấy đường dẫn tuyệt đối đến thư mục chứa file manage_users.py hiện tại
    current_dir = os.path.dirname(os.path.abspath(__file__)) # frontend/pages/admin
    
    # Tìm đường dẫn đến thư mục CSS (lùi 2 cấp từ pages/admin/ rồi vào CSS/)
...
# Tải CSS làm đẹp (Chỉ truyền phần tên thư mục con và file nằm sau thư mục CSS/)
load_css("admin/manage_users.css")
...
with st.form("admin_create_user"):
    ...
    if submit:
        ...
        if not full_name or not email or not password:
            ...
            try:
                # URL Backend - Đảm bảo Backend đang chạy tại port 8000
