...
# ==========================================
# BỘ TỪ ĐIỂN SONG NGỮ CHI TIẾT (ĐÃ XÓA ICON)
# ==========================================
CLASS_LABELS = {
    "vi": {
    ...
    "en": {
        ...
        "warn_no_teacher": "No valid teachers found. Please verify the staff database registries.",
        ...
        "warn_delete": "Class deletion is permanent and all associated records will be un-recoverable!",
                        ...
                        if st.form_submit_button(CLASS_LABELS[lang]["btn_save_changes"], type="primary", use_container_width=True):
                            if not n_name:
                                ...
                                if n_t_label:
                                    ...
                                    upd["teacher_name"] = sel_t["name"]
                                else:
                                    upd["teacher_id"] = sel.get("teacher_id")
